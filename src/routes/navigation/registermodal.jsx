...
const ModalRegister = ({showRegister,onModalCloseRegister,onModalOkRegister}) => {
       ...
       <div className="modalpopup">
            <Modal show={showRegister} style={{marginTop:'200px'}}>
                ...
                <div className='modalbuttons'>
                    <Link className="modalbtns" to='/SignupSeller' onClick={onModalOkRegister}>  
                        <Button style={{fontSize:'20px',width:'150px',backgroundColor:'rgba(0,0,0,0.8)'}}>Seller</Button>
                    </Link>
                    <Link className="modalbtns" to='/SignupBuyer' onClick={onModalOkRegister}>  
