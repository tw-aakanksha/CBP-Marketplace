...
const LoginSeller = () => {
    ...
    const handleSubmit = async(event) =>
    {
        ...
        try{
            const response = await signInAuthUserWithEmailAndPassword_Seller(email,password);
    ...
    return(
        ...
        <div className="login-container-seller">
            <h1>
                Already have an account as a Seller ?
            </h1>
            <span>
            ...
            <label>Password</label>
                ...
                <button type="submit" className="button-loginseller">LOG IN</button>
