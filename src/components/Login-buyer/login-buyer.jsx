...
const LoginBuyer = () => {
    ...
    const handleSubmit = async(event) =>
    {
        ...
        try{
            const response = await signInAuthUserWithEmailAndPassword_Buyer(email,password);
    ...
    return(
        ...
        <div className="login-container-buyer">
            <h1>
                Already have an account as a Buyer ?
            </h1>
            <span>
            ...
            <button type="submit" className="button-loginbuyer">LOG IN</button>
