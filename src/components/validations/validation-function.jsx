...
const  Validation = () => {
    ...
    const formValidations = () => {
        ...
        if (displayName.length < 4 || displayName.length>10  || !(displayName.match(/^[a-zA-Z0-9]+$/))) {
            displayNameErr.displayNameShort = "Firstname should contain 4 letters min,10 letters Max and only numbers";
            isValid = false;
          } 
